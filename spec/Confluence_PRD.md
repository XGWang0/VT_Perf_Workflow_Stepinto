...
This document is optimized for direct import or copy-pasting into **Atlassian Confluence**. All code blocks, lists, and tables conform to Confluence's native Markdown editor standards.
...
> **Confluence Note:** This system leverages a thread-safe session registry to guarantee complete **Concurrency Isolation** for multiple engineers accessing different test machines simultaneously from separate browser tabs.
...
| **Config Loader** | tomllib | Safe native Python binary parsing of TOML files |
...
The following text diagram details the asynchronous communication flow between the Browser Client, FastAPI backend, and the SUT hardware:
